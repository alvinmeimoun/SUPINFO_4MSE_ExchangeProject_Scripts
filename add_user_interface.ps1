...
New-ADUser -Name $Name -Path $pathDepartment -AccountPassword $password -ChangePasswordAtLogon 0 -Enabled 1 -DisplayName $display_name -GivenName $Firstname -Surname $Lastname -City $location -EmailAddress $email
